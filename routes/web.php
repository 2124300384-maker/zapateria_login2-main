...
Route::middleware('auth:empleado')->group(function () {
    ...
    Route::post('/contactos/guardar', [ContactoController::class, 'guardar']);
    Route::post('/empleados/guardar', [EmpleadoController::class, 'guardar']);
    Route::post('/marcas/guardar', [MarcaController::class, 'guardar']);
    Route::post('/tallas/guardar', [TallaController::class, 'guardar']);
    ...
    Route::post('/compras/guardar', [CompraController::class, 'guardar']);
